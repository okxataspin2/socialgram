...
class UserRepository implements UserBaseRepository {
  ...
  Future<List<User>> getAllUsers({
    ...
    required int offset,
      ...
      _databaseClient.getAllUsers(limit: limit, offset: offset);
  ...
  Future<void> addFollower({
    ...
    required String followerId,
      ...
      _databaseClient.addFollower(userId: userId, followerId: followerId);

  @override
  Future<void> deleteUser({required String id}) =>
      _databaseClient.deleteUser(id: id);
  ...
  Future<void> updateUserRole({
    ...
    required String role,
      ...
      _databaseClient.updateUserRole(userId: userId, role: role);
  ...
  Future<List<Map<String, dynamic>>> getAllConversations({
    ...
    required int offset,
      ...
      _databaseClient.getAllConversations(limit: limit, offset: offset);
  ...
  Future<void> createCustomUser({
    ...
    int followingCount = 0,
      ...
      _databaseClient.createCustomUser(
        username: username,
        password: password,
  ...
  Future<void> setImpersonatedUserId(String userId) =>
      _databaseClient.setImpersonatedUserId(userId);

  @override
  Future<void> stopImpersonation() =>
      _databaseClient.stopImpersonation();
}
